...
import 'package:mashrou3i/services/whish_service.dart';
...
class _UserOrdersScreenState extends State<UserOrdersScreen> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // زر الدفع في البطاقة إذا الطلب بحاجة دفع
  ...
  void _confirmPaymentAction(BuildContext context, int orderId, String paymentMethod, {UserOrder? order}) async {
    ...
    if (paymentMethod.toLowerCase() == 'wishmoney') {
      try {
        final thisOrder = order ?? context.read<UserOrdersCubit>().state is UserOrdersLoaded
            ? (context.read<UserOrdersCubit>().state as UserOrdersLoaded)
                .orders
